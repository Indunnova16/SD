...
class InspectionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Información General", {"fields": ("folio", "equipment", "inspector", "status")}),
        (
            "Detalles",
            {
                "fields": (
        ...
        ("Firma Digital", {"fields": ("signature_image",)}),
        (
            "Auditoría",
...
class CorrectiveActionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Información General", {"fields": ("finding", "description", "responsible", "status")}),
        ("Cronograma", {"fields": ("due_date", "completion_date")}),
        ("Notas", {"fields": ("notes",)}),
