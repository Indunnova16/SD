...
class InspectionForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['equipment'].queryset = self.fields['equipment'].queryset.select_related('category')
        self.fields['equipment'].label_from_instance = lambda obj: f"[{obj.category}] {obj.folio} - {obj.name}"
