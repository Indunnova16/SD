...
class InspectionChecklist(models.Model):
    ...
    inspection = models.OneToOneField(Inspection, on_delete=models.CASCADE, related_name='checklist')
...
class CorrectiveAction(models.Model):
    ...
    description = models.TextField()
    responsible = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='corrective_actions')
